    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 4 }}>
          {[
            { key: 'avatar' as const, label: '🎭 伴播形象', active: true },
            { key: 'voice' as const, label: '🔊 伴播音色', active: false },
            { key: 'voiceSwitch' as const, label: '🎙 声控互动', active: false },
            { key: 'autoChat' as const, label: '💬 智能搭话', active: false },          ].map(tab => (
            <button
              key={tab.key}

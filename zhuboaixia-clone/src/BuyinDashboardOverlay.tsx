        ...
        >
          ...
          {showLiveSummary && (
            ...
            <div style={{ padding: '16px 24px 8px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              ...
              <div style={{ background: '#F7F8FA', borderRadius: 10, padding: '12px 14px' }}>
                <div style={{ fontSize: 11, color: '#86909C', marginBottom: 4 }}>使用形象</div>
                <div style={{ fontSize: 24, fontWeight: 700, color: '#1D2129' }}>3<span style={{ fontSize: 14, fontWeight: 500 }}> 个</span></div>
              </div>
              <div style={{ background: '#F7F8FA', borderRadius: 10, padding: '12px 14px' }}>
